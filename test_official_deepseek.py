"""
Test script for official Deepseek API client.
"""
...
def test_deepseek_connection():
    """
    Test the connection to the Deepseek API using the official client.
    """
    # Set the API key
    ...
    try:
        ...
        response = client.api.chat.completions.create(
            model="deepseek-chat",
            messages=[
